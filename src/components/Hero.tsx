...
export default function Hero() {
  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute top-3/4 left-1/2 w-60 h-60 bg-violet-800/15 rounded-full blur-3xl animate-float" style={{ animationDelay: "1.5s" }} />
      ...
      <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
        ...
        <h1 className="text-5xl md:text-7xl font-bold mb-5">
          <span className="text-[var(--t1)]">Alan Chanel </span>
          <br />
          <span
            style={{
        ...
        <div className="flex flex-wrap justify-center gap-2 mb-6">
          {h.roles.map((title) => (
            <span
              key={title}
              className="px-3 py-1 rounded-md bg-[var(--surf)] border border-[var(--brdr2)] text-[var(--t4)] text-sm font-mono"
            >
              {title}
            </span>
          ))}
        ...
        {/* Location */}
        <div className="flex items-center justify-center gap-2 text-[var(--t3)] text-sm mb-5">
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {/* Bio */}
        <p className="text-[var(--t2)] text-lg max-w-2xl mx-auto mb-10 leading-relaxed">
          {h.bio}
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <a
            ...
            download
            className="flex items-center gap-2 px-6 py-3 border border-[var(--brdr2)] hover:border-cyan-500/50 text-[var(--t2)] hover:text-cyan-400 font-medium rounded-full transition-all duration-300 hover:bg-cyan-500/5 text-sm"
          >
            <DownloadIcon />
            {h.cvFullstack}
          </a>
      ...
      {/* Scroll indicator */}
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-[var(--t3)]">
        <span className="text-xs font-mono">scroll</span>
        <div className="w-5 h-8 rounded-full border border-[var(--brdr)] flex items-start justify-center pt-1.5">
